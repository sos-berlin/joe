...
public class EventListener {
    ...
    public void fillEvent(Table table) {
        ...
        try {
            if (type == JOEConstants.ADD_EVENT_GROUP) {
                ...
                l = x3.selectNodes(_eventGroup);
                /*
                 * XPath x3 = XPath.newInstance("//remove_event/event"); l =
                 * x3.selectNodes(_dom.getDoc());
                 */
    ...
    public void apply(String eventName, String eventId, String eventClass, String eventTitle, String jobname, String jobChain, String orderId, String comment,
            String exitCode, String expirationPeriod, String expirationCycle, Table table) {
        ...
        if (table.getSelectionCount() > 0) {
            ...
            // Defaultmässig wird ein leeres Element genommen. Der soll gefüllt
            // werden
    ...
    public String getActionName() {
        ...
        /*
         * if(_eventGroup != null && _eventGroup.getParentElement() != null &&
         * _eventGroup.getParentElement().getParentElement() != null &&
         * _eventGroup.getParentElement().getParentElement().equals("action")) {
         * return Utils.getAttributeValue("name",
         * _eventGroup.getParentElement().getParentElement()); } else
         * if(_eventGroup != null && _eventGroup.getParentElement() != null &&
         * _eventGroup.getParentElement().getParentElement() != null &&
         * _eventGroup.getParentElement().getParentElement().equals("action")) }
         * else
