...
public class EventsForm extends SOSJOEMessageCodes implements IUnsaved {
	...
	private void createGroup() {
		...
		@SuppressWarnings("unused") final Label lblLogic = JOE_L_EventsForm_Logic.Control(new Label(actionsGroup, SWT.NONE));
		...
		@SuppressWarnings("unused") final Label groupLabel = JOE_L_EventsForm_Group.Control(new Label(group, SWT.NONE));
		...
		@SuppressWarnings("unused") final Label logicLabel = JOE_L_EventsForm_Logic.Control(new Label(group, SWT.NONE));
		...
		@SuppressWarnings("unused") final Label eventClassLabel = JOE_L_EventsForm_EventClass.Control(new Label(group, SWT.NONE));
