...
public class EventForm extends SOSJOEMessageCodes implements IUnsaved {
    ...
    private void initialize() {
        ...
        if (type == JOEConstants.EVENT_GROUP)
            ...
            // group.setText(" Action: " + listener.getActionName() +
            // " Remove Event " );
        ...
        matchingAttributesGroup.setTabList(new org.eclipse.swt.widgets.Control[] { cboEventClass, txtEventId, txtJobname, txtJobChain, txtOrderId, txtExitCode });
