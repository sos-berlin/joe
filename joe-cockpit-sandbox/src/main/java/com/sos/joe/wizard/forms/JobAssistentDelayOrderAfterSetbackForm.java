...
public class JobAssistentDelayOrderAfterSetbackForm {
	...
	public void showDelayOrderAfterSetbackForm() {
		...
		txtSetBack.setFocus();
		{
			@SuppressWarnings("unused") final Label lblNumberOfSetBack = SOSJOEMessageCodes.JOE_L_JobAssistent_NumOfSetback.Control(new Label(jobGroup,
					SWT.NONE));
