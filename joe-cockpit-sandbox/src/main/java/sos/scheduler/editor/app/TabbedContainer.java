...
public class TabbedContainer implements IContainer {
	...
	@Override public SchedulerForm newScheduler(final int type) {
	...
	@Override public SchedulerForm openScheduler(final String filename) {
		SchedulerForm scheduler = new SchedulerForm(this, folder, SWT.NONE);
	...
	@Override public DocumentationForm openDocumentation(final String filename) {
		try {
			DocumentationForm doc = new DocumentationForm(folder, SWT.NONE);
	...
	@Override public SchedulerForm openDirectory(final String filename) {
		SchedulerForm scheduler = new SchedulerForm(this, folder, SWT.NONE, SchedulerDom.DIRECTORY);
	...
	@Override public Composite openQuick(final String xmlFilename) {
