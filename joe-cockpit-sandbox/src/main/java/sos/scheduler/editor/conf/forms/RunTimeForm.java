...
public class RunTimeForm extends SOSJOEMessageCodes implements IUpdateLanguage {
	...
	public RunTimeForm(final Composite parent, final int style, final SchedulerDom dom, final Element job, final ISchedulerUpdate gui) {
		...
		setToolTipText();
		dom.setInit(true);
		gRunTime.setEnabled(Utils.isElementEnabled("job", dom, job));
