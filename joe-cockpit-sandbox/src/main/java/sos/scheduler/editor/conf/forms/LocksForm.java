...
public class LocksForm extends SOSJOEMessageCodes implements IUnsaved, IUpdateLanguage {
	...
	public LocksForm(final Composite parent, final TreeData pobjTreeData) {
	 ...
	 */
	@Deprecated public LocksForm(final Composite parent, final int style, final SchedulerDom dom_, final Element config) throws JDOMException {
		super(parent, style);
		dom = dom_;
