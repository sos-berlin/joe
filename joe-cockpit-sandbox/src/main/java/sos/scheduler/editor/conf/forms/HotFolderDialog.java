...
public class HotFolderDialog {
	...
	private void createTreeItem(final TreeItem parentItem, final java.util.Vector filelist, final boolean sub) {
		try {
			...
			while (fileIterator.hasNext()) {
				...
				if (type == SCHEDULER_CLUSTER) {
					...
					java.util.Vector subFilelist = sos.util.SOSFile.getFolderlist(filename, SCHEDULER_CLUSTER_MASK, java.util.regex.Pattern.CASE_INSENSITIVE,
							false);
