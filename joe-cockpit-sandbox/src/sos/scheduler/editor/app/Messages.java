...
public class Messages {
	...
	public static boolean setResource(final Locale pobjLocale) {
	...
	public static String getString(final String key, final String variable) {
		strLastMsgKey = key;
		return getMsgObj().getMsg(key, variable);
	}

	public static String getMsg(final String key, final Object... pstrArgs) {
		strLastMsgKey = key;
	...
	public static String getLabel(final String pstrKey) {
	...
	public static String getF1(final String pstrKey) {
		String key = pstrKey.trim().replaceAll(" ", "");
		try {
			strLastMsgKey = key;
