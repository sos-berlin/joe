...
public class ActionsListener implements IUpdateTree {
    ...
    private final ActionsDom _dom;
    private final ActionsForm _gui;
    ...
    public ActionsListener(final ActionsForm gui, final ActionsDom dom) {
    	_gui = gui;
        _dom = dom;
    }
    ...
    @Override
	public void treeFillAction(final TreeItem parent) {
    ...
    public void fillCommands(final TreeItem parent, final Element action) {
    	TreeItem item = new TreeItem(parent, SWT.NONE);
    ...
    public void fillEvents(final TreeItem parent,final Element action) {
    	parent.removeAll();
    ...
    public void fillEventGroup(final TreeItem parent,final Element action) {
    	parent.removeAll();
    ...
    public void treeFillCommands(final TreeItem parent, final Element action, final boolean expand) {
    ...
    public void treeFillAddRemoveEvent(final TreeItem parent, final Element eCommands) {
    ...
    public void treeFillCommand(final TreeItem parent, final Element elem, final boolean expand) {
	...
	private void treeFillCommand(final TreeItem parent,final List cmdList) {
