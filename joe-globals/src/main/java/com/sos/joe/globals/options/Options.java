...
@I18NResourceBundle(baseName = "JOEMessages", defaultLocale = "en") public class Options extends JSToolBox {
	...
	private static void getProperties() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getProperties";
		if (_properties == null) {
	...
	@Deprecated public static void loadWindow(final Shell shell, final String name) {
		getProperties();
	...
	@Deprecated public static void saveSash(final String name, final int[] sash) {
