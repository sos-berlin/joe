...
public class FTPProfileDialog {
	...
	public FTPProfileDialog(File configFile) throws Exception {
		try {
			FTPProfile.log("calling " + sos.util.SOSClassUtil.getMethodName(),
					SOSLogger.DEBUG9);
			...
			throw new Exception("error in "
					+ sos.util.SOSClassUtil.getMethodName() + " cause: "
					+ e.toString());
		}
	}
	...
	public void fillCombo(Combo combo_) throws Exception {
		try {
			...
			combo.setText(listener.getCurrProfileName() != null ? listener
					.getCurrProfileName() : "");
	...
	public void showModal(Combo combo_) {
		...
		try {
...

			{
				...
				final TabFolder tabFolder = new TabFolder(schedulerGroup,
						SWT.NONE);
				final GridData gridData_1 = new GridData(GridData.FILL,
						GridData.FILL, true, true, 1, 4);
				gridData_1.heightHint = 178;
				tabFolder.setLayoutData(gridData_1);

				final TabItem propertiesTabItem = new TabItem(tabFolder,
						SWT.NONE);
				...
				cboConnectname.addSelectionListener(new SelectionAdapter() {
					public void widgetSelected(final SelectionEvent e) {
						if (!cboConnectname.getText().equals(
				...
				cboProtokol.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, true, false, 2, 1));
				...
				txtHost.setLayoutData(new GridData(GridData.FILL,
				...
				txtPort.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, false, false, 2, 1));
				...
				txtUsername.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, false, false, 2, 1));
				...
				txtPassword.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, false, false, 2, 1));
				...
				txtRoot.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, false, false, 2, 1));
				...
				txtLocalDirectory.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, false, false, 2, 1));
				...
				useProxyButton.addSelectionListener(new SelectionAdapter() {
					public void widgetSelected(final SelectionEvent e) {
						...
						txtProxyPassword.setEnabled(useProxyButton
								.getSelection());
						cboProxyProtocol.setEnabled(useProxyButton
								.getSelection());
						setEnabled();
					}
				});
				...
				txtProxyServer.setLayoutData(new GridData(GridData.FILL,
				...
				txtProxyPort.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, true, false));
				...
				txtProxyUser.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, true, false));
				...
				txtProxyPassword.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, true, false));
				...
				cboProxyProtocol.setItems(new String[] { "http", "socks4",
						"socks5" });
				...
				final GridData gridData_pk = new GridData(GridData.BEGINNING,
						GridData.END, false, false, 2, 1);
				butPublicKey.setLayoutData(gridData_pk);
				butPublicKey.setText("Public Key");

				butAuthPassword = new Button(groupAuthenticationMethods,
						SWT.RADIO);
				...
				butAuthPassword.setLayoutData(new GridData(GridData.BEGINNING,
						GridData.CENTER, false, false, 2, 1));
				butAuthPassword.setText("Password");

				final Label passphraseLabel = new Label(
						groupAuthenticationMethods, SWT.NONE);
				passphraseLabel.setText("Passphrase");
				txtPassphrase = new Text(groupAuthenticationMethods,
				...
				txtPassphrase.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, false, false, 2, 1));

				final Label pathToPublicLabel = new Label(
						groupAuthenticationMethods, SWT.NONE);
				pathToPublicLabel
				...
				txtDirPublicKey = new Text(groupAuthenticationMethods,
						SWT.BORDER);
				...
				txtDirPublicKey.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, true, false));

				final Button button_4 = new Button(groupAuthenticationMethods,
						SWT.NONE);
				...
				butApply.addSelectionListener(new SelectionAdapter() {
					public void widgetSelected(final SelectionEvent e) {
						try {
							...
							message("could not apply, cause: " + ex.toString(),
									SWT.ICON_WARNING);
						}

					}
				});
				butApply.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, false, false));
				butApply.setText("Apply");

				final Button butNewProfile = new Button(schedulerGroup,
						SWT.NONE);
				...
				butNewProfile.setLayoutData(new GridData(GridData.FILL,
						GridData.CENTER, false, false));
				...
				butRemove.setLayoutData(new GridData(GridData.FILL,
			...
			butClose.setLayoutData(new GridData(GridData.END, GridData.CENTER,
					false, false));
			...
			message("could not open Profile Dialag cause: " + e.toString(),
					SWT.ICON_WARNING);
		}
	}
	...
	private void initForm() {
		...
		try {
			...
			currProfile = listener.getProfiles().get(cboConnectname.getText()) != null ? (FTPProfile) listener
					.getProfiles().get(cboConnectname.getText())
			...
			txtLocalDirectory.setText(currProfile
					.getLocaldirectory(getInitValueLocalDirectory()));
			...
			if (useProxyButton.getSelection()) {
				...
				txtProxyServer.setText(sosString.parseToString(currProfile
						.getProxyServer()));
				txtProxyUser.setText(sosString.parseToString(currProfile
						.getProxyUser()));
				txtProxyPassword.setText(sosString.parseToString(currProfile
						.getProxyPassword()));
				cboProxyProtocol.setText(sosString.parseToString(currProfile
						.getProxyProtocol()));
				txtProxyPort.setText(sosString.parseToString(currProfile
						.getProxyPort()));
			} else {
				txtProxyServer.setEnabled(false);
				txtProxyPort.setEnabled(false);
			...
			String protocol = sosString
					.parseToString(currProfile.getProtocol());
			...
			if (protocol.equalsIgnoreCase("SFTP")) {
				groupAuthenticationMethods.setEnabled(true);
				txtDirPublicKey.setText(sosString.parseToString(currProfile
						.getAuthFile()));
				String method = sosString.parseToString(currProfile
						.getAuthMethod());
			...
			message("could not reaad FTP Profiles:" + e.getMessage(),
					SWT.ICON_WARNING);
	...
	private void apply() throws Exception {
		try {
			...
			prop.put("transfermode", butbinary.getSelection() ? "binary"
					: "ASCII");
			prop.put("passivemode", butPassive.getSelection() ? "true"
					: "false");
			prop.put("save_password", (butSavePassword.getSelection() ? "yes"
					: "no"));
			...
			if (newProfile
					&& !listener.getProfiles().containsKey(
							cboConnectname.getText())
			...
			try {
				...
				message("could not create an FTPProfile Object, cause: "
						+ e.toString(), SWT.ICON_ERROR);
			}
			...
			throw new Exception("error in "
					...
					+ ", could not apply profile, cause: " + e.toString());
		}
	}
	...
	private void close() {
		...
		try {
			...
			FTPProfile
					.log("error in FTPProfileDialog.close(), cause: "
							+ e.toString(), -1);
		} finally {
			try {
				fillCombo(combo);
				...
				FTPProfile.log(
						"error in FTPProfileDialog.close(), cause: "
								+ e.toString(), -1);
			}
		}
		stopCursor(shell);
