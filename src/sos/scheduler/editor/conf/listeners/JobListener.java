...
public class JobListener extends JOEListener {
	...
	public String getJobNameAndTitle() {
		final String strDisabledText = " ( " + sos.scheduler.editor.app.Messages.getLabel("disabled") + ")";
		return ("Job: " + this.getJobName() + (this.isDisabled() ? strDisabledText : "" + " - " + this.getTitle()));
	}
