				...
				if (objTreeItemUserdata != null) {
					...
					switch (intType) {
						...
						case Editor.MONITORS:
							...
							break;
						case Editor.MONITOR:
							new ScriptForm(c, SWT.NONE, MONITOR, objSchedulerDom, objElement, intType, objSchedulerForm);
							break;
						case Editor.SCRIPT:
							new ScriptForm(c, SWT.NONE, "Start Script", objSchedulerDom, objElement, intType, objSchedulerForm);
							break;
						case Editor.JOB:
							new JobMainForm(c, SWT.NONE, objSchedulerDom, objElement, objSchedulerForm);
							break;
						...
						case Editor.JOB_DOCUMENTATION:
							...
							break;
						case Editor.EXECUTE:
							new ExecuteForm(c, SWT.NONE, objSchedulerDom, objElement, objSchedulerForm);
							break;
