...
public class SOSSplashScreen {
	...
	public static void startJOEExecuteLoop(final Shell pobjParentShell, final Runnable pobjRunnable, final Image pobjImage2Show, final Method m, final int pintHowLong2Show)
			throws Exception {
...
public class SOSSplashScreen {
	...
	public static void showSplashScreen(final Shell pobjParentShell, final Runnable pobjRunnable, final Image pobjImage2Show, final Method m, final int pintHowLong2Show)
			throws Exception {
