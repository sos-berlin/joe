...
public class TextArea extends StyledText /* Text */{
	...
	public void setDataProvider(final JobListener pobjDataProvider, final enuSourceTypes penuWhatSourceType) {
	...
	public void refreshContent() {
		...
		switch (enuWhatSourceType) {
			...
			case MonitorSource:
//				setText(objDataProvider.getMonitorSource());
				strTagName = "job";
			...
			public void modifyText(ModifyEvent e) {
				...
				if (flgInit == false) {
					switch (enuWhatSourceType) {
						...
						case MonitorSource:
//							objDataProvider.setMonitorSource(getText());
							break;
