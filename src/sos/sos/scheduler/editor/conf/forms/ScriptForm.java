...
public class ScriptForm extends Composite implements IUnsaved, IUpdateLanguage {
	...
	if ( type == Editor.MONITOR) {
		...
		final GridData gridData_5 = new GridData(GridData.FILL, GridData.FILL, true, true, 13, 3);
		...
		label1 = new Label(gScript_1, SWT.NONE);
		...
		new Label(gScript_1, SWT.NONE);
				...
				Label lblClasspath = new Label(gScript_1, SWT.NONE);
				...
				GridData gd_tClasspath = new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1);
				gd_tClasspath.widthHint = 326;
		...
		gInclude.setLayoutData(new GridData(GridData.FILL, GridData.BEGINNING, false, false, 13, 1));
