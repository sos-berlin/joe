...
*/
    public void addCommand(Element e) {
        ...
        //_main.updateExitCodesCommand(Utils.getAttributeValue("job_chain", e) != null && Utils.getAttributeValue("job_chain", e).length() > 0? Utils.getAttributeValue("job_chain", e) : Utils.getAttributeValue("job", e));
