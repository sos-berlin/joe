...
public class ProcessClassesForm extends Composite implements IUnsaved, IUpdateLanguage {
	 ...
	 */
	public ProcessClassesForm(Composite parent, int style, DomParser dom, Element config)
			throws JDOMException {
		super(parent, style);
		...
		tProcessClass
				.addModifyListener(new org.eclipse.swt.events.ModifyListener() {
					public void modifyText(org.eclipse.swt.events.ModifyEvent e) {
						boolean valid = listener.isValidClass(tProcessClass
								.getText());
						if (valid)
							tProcessClass.setBackground(null);
						else
							tProcessClass.setBackground(Display.getCurrent()
		...
		table
				.addSelectionListener(new org.eclipse.swt.events.SelectionAdapter() {
					public void widgetSelected(
						...
						if (selection) {
							listener.selectProcessClass(table
									.getSelectionIndex());
							setInput(true);
							tProcessClass.setBackground(null);
						}
	...
	private void applyClass() {
		listener.applyProcessClass(tProcessClass.getText(), sMaxProcesses
