...
import sos.scheduler.editor.listeners.CommandsListener;
...
public class CommandsForm extends Composite implements  IUpdateLanguage {
	...
	public CommandsForm(Composite parent, int style, DomParser dom,IUpdate main) throws Exception {
		super(parent, style);
	...
	private void createGroup() {
		...
		tCommands.setFont(SWTResourceManager.getFont("Courier New", 8, SWT.NONE));
