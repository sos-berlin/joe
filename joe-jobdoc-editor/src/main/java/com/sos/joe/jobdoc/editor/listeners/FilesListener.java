...
public class FilesListener extends JobDocBaseListener<DocumentationDom> {

    private Element _resources;
    private Element _file;
    private String[] _platforms = { "all", "win32", "win64", "linux32", "linux64", "solaris32", "solaris64", "hpux64" };
