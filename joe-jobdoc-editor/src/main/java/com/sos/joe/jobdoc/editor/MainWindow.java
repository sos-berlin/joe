...
public class MainWindow implements IEditorAdapter {
    ...
    private void initialize() {
        ...
        objCTabFolder.addTraverseListener(new TraverseListener() {
            ...
            public void keyTraversed(final TraverseEvent e) {
                 ...
                 * System.out.println(folder.getChildren().length); IEditor
                 * editor = (IEditor)folder.getSelection().getControl();
                 * filelist.remove(editor.getFilename()); editor.close();
    ...
    private void createMenu() {
        ...
        pSaveAs.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
                ...
                // container.getCurrentEditor().applyChanges()) {
                ...
                // container.getCurrentTab().setData("ftp_remote_directory",
                // null);
                // container.getCurrentTab().setData("ftp_hot_folder_elements",
                // null);
    ...
    /** This method initializes sShell Will only be executed with JOE using in
     * Dashboard
     * 
     * @wbp.parser.entryPoint */
    ...
    /*
     * private void saveWindowPosAndSize() { objPersistenceStore.saveWindow();
     * objPersistenceStore.restoreWindowSize(); }
     */
    ...
    // /**
    // * Erzeugt einen Confirm-Dialog, wenn der Button zum schließen des
    // Fensters
    // * betätigt wird.
    // *
    ...
    private void createToolBar() {
         ...
         * itemDetails.setText("Details"); itemDetails.addSelectionListener(new
         * SelectionListener() { public void
         * widgetSelected(org.eclipse.swt.events.SelectionEvent e) { if
         * (container.newDetails() != null) setSaveStatus(); } public void
    ...
    // locale = "de", //
    // explanation =
    // "JOE wird neu initialisiert. Die Einstellungen werden neu geladen" //
    // ), //
