...
public class JobAssistentExecuteForms {
    ...
    public void showExecuteForm() {
        ...
        Utils.createHelpButton(composite2, "JOE_M_JobAssistentExecuteForm_Help.label", shell);
        shell.layout();
    }
    ...
    private void refreshJob() {
        ...
        if (comLanguage.getSelectionIndex() > 1
                && txtInclude.getText() != null
                && !txtInclude.getText().trim().isEmpty()
                && (scriptlistener.getIncludes().length == 0
