 ...
 * 
 * Es werden im nächsten Dialog (Job Auswahl Dialoge) entsprechend Standalone
 * Jobs oder Auftragsgesteuerte Jobs zur Auswahl gestellt.
 * 
 * Die Kriterien stehen in der Job Dokumentation. Das bedeutet alle Job
 * Dokumentationen aus der Verzeichnis <SCHEDULER_HOME>/jobs/*.xml werden
 * parsiert.
 * 
 * 
