...
public class JobAssistentTasksForm {
    ...
    private void init() {
        ...
        if (job != null && "unbounded".equals(Utils.getAttributeValue("tasks", job))) {
    ...
    public void showTasksForm() {
        ...
        if (Utils.getAttributeValue("tasks", joblistener.getJob()) != null && "unbounded".equals(Utils.getAttributeValue("tasks", joblistener.getJob()))) {
        ...
        txtTask.addModifyListener(new ModifyListener() {
            ...
            public void modifyText(final ModifyEvent e) {
                if (txtTask.getText() != null && !txtTask.getText().trim().isEmpty()) {
        ...
        txtMinTasks.addModifyListener(new ModifyListener() {
            ...
            @Override
            public void modifyText(final ModifyEvent e) {
                if (txtMinTasks.getText() != null && !txtMinTasks.getText().trim().isEmpty()) {
        ...
        final GridData gridData2 = new GridData(GridData.END, GridData.CENTER, false, false);
        gridData2.widthHint = 250;
        composite_2.setLayoutData(gridData2);
        ...
        tasksShell.setBounds((screen.width - tasksShell.getBounds().width) / 2, (screen.height - tasksShell.getBounds().height) / 2, 
                tasksShell.getBounds().width, tasksShell.getBounds().height);
        tasksShell.open();
    }
    ...
    private boolean checkTasks() {
        if ((txtTask.getText() != null && !txtTask.getText().trim().isEmpty()) && (txtMinTasks.getText() != null 
                && !txtMinTasks.getText().trim().isEmpty()) && Integer.parseInt(txtMinTasks.getText()) > Integer.parseInt(txtTask.getText())) {
            ErrorLog.message(tasksShell, SOSJOEMessageCodes.JOE_M_JobAssistent_MinTasksTooLarge.label(), SWT.ICON_WARNING | SWT.OK);
            return false;
        }
        if ((txtTask.getText() != null && txtTask.getText().trim().isEmpty())
                && (txtMinTasks.getText() != null && !txtMinTasks.getText().trim().isEmpty()) && Integer.parseInt(txtMinTasks.getText()) > 1) {
            ErrorLog.message(tasksShell, SOSJOEMessageCodes.JOE_M_JobAssistent_MinTasksTooLarge.label(), SWT.ICON_WARNING | SWT.OK);
            return false;
        }
        return true;
