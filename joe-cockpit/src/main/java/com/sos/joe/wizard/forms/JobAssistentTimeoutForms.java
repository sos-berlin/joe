...
public class JobAssistentTimeoutForms {
    ...
    public void showTimeOutForm() {
        ...
        composite2.setLayoutData(new GridData(GridData.END, GridData.CENTER, true, false));
        ...
        Utils.createHelpButton(composite2, "JOE_M_JobAssistentTimeoutForms_Help.label", shellTimeout);
        txtTimeout.setFocus();
        shellTimeout.layout();
    }
