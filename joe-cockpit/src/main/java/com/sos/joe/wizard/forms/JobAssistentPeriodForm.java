...
public class JobAssistentPeriodForm extends SOSJOEMessageCodes {
    ...
    private final String savBeginHours = "";
    private final String savBeginMinutes = "";
    private final String savBeginSeconds = "";
    private final String savEndHours = "";
    private final String savEndMinutes = "";
    private final String savEndSeconds = "";
