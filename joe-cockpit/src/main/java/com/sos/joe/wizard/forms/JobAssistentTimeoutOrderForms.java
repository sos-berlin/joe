...
public class JobAssistentTimeoutOrderForms {
    ...
    public void showTimeOutForm() {
        ...
        final Composite composite_2 = new Composite(shellTimeout, SWT.NONE);
        ...
        Utils.createHelpButton(composite_2, "JOE_M_JobAssistent_TimeoutOrderForms_Help.label", shellTimeout);
        txtTimeout.setFocus();
        shellTimeout.layout();
    }
