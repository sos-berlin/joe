...
public class HotFolderDialog {
    ...
    public void showForm(int type_) {
        ...
        butRename.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(final SelectionEvent e) {
                try {
                    if (tree.getSelectionCount() > 0 && !tree.getSelection()[0].getText().equals(sType) && !txtName.getText().trim().isEmpty()) {
                        ...
                        if (type == SCHEDULER_HOST && !txtName.getText().isEmpty() && txtPort.getText().isEmpty()) {
                            changeHost(path);
                            return;
                        } else if (type == SCHEDULER_HOST && !txtName.getText().isEmpty() && !txtPort.getText().isEmpty()
            ...
            while (fileIterator.hasNext()) {
                ...
                if (type == SCHEDULER_CLUSTER) {
                    ...
                    if (sub) {
                        ...
                        if (!sosString.parseToString(name).isEmpty()) {
                        ...
                        while (hostIterator.hasNext()) {
                            ...
                            newItem.setData(new File(path, sname).getCanonicalPath());
    ...
    private void openDirectory() {
        try {
            ...
            if (tree.getSelectionCount() > 0) {
                ...
                } else if (!tree.getSelection()[0].getText().equals(sType) && MainWindow.getContainer().openDirectory(path) != null) {
                    MainWindow.setSaveStatus();
                }
    ...
    private void setButtonRenameEnable() {
        if (tree.getSelectionCount() > 0 && !tree.getSelection()[0].getText().equals(sType)) {
            if (type == SCHEDULER_HOST) {
                ...
                if (!txtName.getText().isEmpty() && !txtPort.getText().isEmpty()) {
        ...
        butAdd.setEnabled(!txtName.getText().isEmpty());
    }
    ...
    private void addItem() {
        try {
            ...
            if (!newFile.exists() && !new File(path).mkdirs()) {
