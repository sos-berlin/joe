...
public class DateForm extends SOSJOEMessageCodes {
        ...
        bAddDay.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(final SelectionEvent e) {
                ...
                try {
                    ...
                    // MainWindow.message(sDate + " is not a valid Date: " +
                    // ex.getMessage(), SWT.ICON_ERROR);
    ...
    private void createGroupForIncludes() {
        ...
        tableIncludes.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(final SelectionEvent e) {
                ...
                /*
                 * Object fname =
                 * Options.getHolidaysDescription().get(tableIncludes
                 * .getSelection()[0].getText()); if(fname != null &&
                 * fname.toString().length() > 0)
        ...
        /*
         * Wir nehmen diese Spalte erstmal raus, weil nicht klar ist, wie die
         * description zu stande kommt.ur20120723 final TableColumn
         * newColumnTableColumn_1 = new TableColumn(tableIncludes, SWT.NONE);
         * newColumnTableColumn_1.setWidth(67);
         * newColumnTableColumn_1.setText("File/Life File"); // final
         * TableColumn newColumnTableColumn_1 =
         * JOE_TCl_DateForm_FileColumn.Control(new TableColumn(tableIncludes,
         * SWT.NONE)); // newColumnTableColumn_1.setWidth(67);
         */
        ...
        bRemove.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(final SelectionEvent e) {
                removeInclude();
                /*
                 * if (tableIncludes.getSelectionCount() > 0) { int index =
                 * tableIncludes.getSelectionIndex();
                 * listener.removeInclude(index);
                 * listener.fillTable(tableIncludes); if (index >=
                 * tableIncludes.getItemCount()) index--; if
                 * (tableIncludes.getItemCount() > 0)
    ...
    private void openInclude() {
        ...
        try {
            ...
            // MainWindow.message("could not open Holiday File" +
            // ex.getMessage(), SWT.ICON_ERROR);
