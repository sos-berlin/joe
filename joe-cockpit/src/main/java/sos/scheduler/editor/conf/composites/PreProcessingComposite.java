...
public class PreProcessingComposite extends SOSJOEMessageCodes {
	...
	@SuppressWarnings("unused") private static Logger	logger			= Logger.getLogger(PreProcessingComposite.class);
	@SuppressWarnings("unused") private final String	conClassName	= "PreProcessingComposite";
	...
	private void createGroup(final Group parent) {
		...
		@SuppressWarnings("unused") final Label orderingLabel = JOE_L_PreProcessingComposite_Ordering.Control(new Label(scriptcom, SWT.NONE));
