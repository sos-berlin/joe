...
public class JobEmailSettings extends FormBaseClass {
	...
	@SuppressWarnings("unused") private final String	conClassName			= "JobEmailSettings";
	...
	private void createGroup() {
		...
		@SuppressWarnings("unused") Label labelMailOnError = SOSJOEMessageCodes.JOE_L_MailForm_MailOnError.Control(new Label(group4EMail, SWT.NONE));
		...
		@SuppressWarnings("unused") Label labelMailOnWarning = SOSJOEMessageCodes.JOE_L_MailForm_MailOnWarning.Control(new Label(group4EMail, SWT.NONE));
		...
		@SuppressWarnings("unused") Label label3 = SOSJOEMessageCodes.JOE_L_MailForm_MailOnSuccess.Control(new Label(group4EMail, SWT.NONE));
		...
		@SuppressWarnings("unused") final Label mailOnProcessLabel = SOSJOEMessageCodes.JOE_L_MailForm_MailOnProcess.Control(new Label(group4EMail, SWT.NONE));
		...
		@SuppressWarnings("unused") final Label mailOnDelayLabel = SOSJOEMessageCodes.JOE_L_MailForm_MailOnDelayAfterError.Control(new Label(group4EMail,
				SWT.NONE));
		...
		@SuppressWarnings("unused") final Label mailToLabel = SOSJOEMessageCodes.JOE_L_MailForm_MailTo.Control(new Label(group4EMail, SWT.NONE));
		...
		@SuppressWarnings("unused") final Label mailCcLabel = SOSJOEMessageCodes.JOE_L_MailForm_MailCC.Control(new Label(group4EMail, SWT.NONE));
		...
		@SuppressWarnings("unused") final Label mailBccLabel = SOSJOEMessageCodes.JOE_L_MailForm_MailBCC.Control(new Label(group4EMail, SWT.NONE));
