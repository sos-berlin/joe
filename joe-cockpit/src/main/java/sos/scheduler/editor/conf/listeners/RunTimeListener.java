...
public class RunTimeListener {
    ...
    /*
     * Runtime darf Starttime nicht im Attribut haben. Der Starttime darf nur in
     * Perioden definiert werden. Wenn ein run_time Element bereits definitionen
     * aus der Starttime hat (repeat_time und single_time und absolute_repeat),
