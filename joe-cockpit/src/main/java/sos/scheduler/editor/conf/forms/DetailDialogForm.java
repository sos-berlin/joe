...
public class DetailDialogForm {
    ...
    /** Wenn es eine JobDokumentation gibt, dann wird beim Starten der Wizzard
     * die Parameter Fenster geöffnet */
    ...
    // public DetailDialogForm(String jobChainname_, String state_, String[]
    // listOfOrderIds_, boolean isLifeElement_, String path_) {
    ...
    /*
     * public void showDetails(String descriptionname_) { descriptionname =
     * descriptionname_; showDetails(); }
     */
    public void showDetails() {
        ...
        // dialogForm =new DetailForm(composite, SWT.NONE, jobChainname, state,
        // listOfOrderIds, JOEConstants.JOB_CHAINS, null, null,
        // isLifeElement, path);
