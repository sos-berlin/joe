...
public class DaysForm extends SOSJOEMessageCodes {
    ...
    private void createGroup() {
        ...
        switch (_type) {
        case 0:
            strT = JOE_L_DaysForm_Weekday.label();
            break;
        case 1:
            strT = JOE_L_DaysForm_Monthday.label();
            break;
        case 2:
            strT = JOE_L_DaysForm_Ultimo.label();
            break;
        case 3:
            strT = JOE_L_DaysForm_Month.label();
            break;
        default:
            strT = JOE_L_DaysForm_Weekday.label();
            break;
        ...
        switch (_type) {
        case 0:
            strT = JOE_G_DaysForm_WeekdaysGroup.label();
            break;
        case 1:
            strT = JOE_G_DaysForm_MonthdaysGroup.label();
            break;
        case 2:
            strT = JOE_G_DaysForm_UltimosGroup.label();
            break;
        case 3:
            strT = JOE_G_DaysForm_MonthGroup.label();
            break;
        default:
            strT = JOE_G_DaysForm_WeekdaysGroup.label();
            break;
        ...
        switch (_type) {
        case 0:
            strT = JOE_B_DaysForm_AddWeekday.label();
            break;
        case 1:
            strT = JOE_B_DaysForm_AddMonthday.label();
            break;
        case 2:
            strT = JOE_B_DaysForm_AddUltimo.label();
            break;
        case 3:
            strT = JOE_B_DaysForm_AddMonth.label();
            break;
        default:
            strT = JOE_B_DaysForm_AddWeekday.label();
            break;
    ...
    private void addGroupDay() {
        if (listOfDays.getSelectionCount() > 0) {
            ...
            for (int i = 0; i < listOfGroup.getItemCount(); i++) {
                ...
                if (_type == DaysListener.SPECIFIC_MONTHS && listOfSameMonths.get(listOfGroup.getItem(i)).equals(listOfDays.getSelection()[0])) {
                    exist = true;
                }
            }
            if (!exist) {
