...
public class JobMainOptionForm extends SOSJOEMessageCodes implements IUpdateLanguage {
	...
	private void createGroup() {
		...
		@SuppressWarnings("unused") final Label warnIfLongerLabel = JOE_L_JobMainOptionForm_WarnIfLonger.Control(new Label(gMain, SWT.NONE));
		...
		@SuppressWarnings("unused") final Label warnIfShorterLabel = JOE_L_JobMainOptionForm_WarnIfShorter.Control(new Label(gMain, SWT.NONE));
