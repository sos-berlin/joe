...
public class ConfigForm extends SOSJOEMessageCodes  {
	...
	@SuppressWarnings("unused") private Label	label12_2					= null;
	...
	@SuppressWarnings("unused") private Label	label12						= null;
	...
	private void createGConfig() {
		...
		@SuppressWarnings("unused") final Label ipaddressLabel = JOE_L_ConfigForm_IPAddress.Control(new Label(group_1, SWT.NONE));
