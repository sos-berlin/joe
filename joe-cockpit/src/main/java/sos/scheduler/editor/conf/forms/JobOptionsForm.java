...
public class JobOptionsForm extends SOSJOEMessageCodes implements IUnsaved {
	...
	@SuppressWarnings("unused") private Label	label14				= null;
	private Text								sErrorMinutes		= null;
	@SuppressWarnings("unused") private Label	label17				= null;
	...
	private void createGroup3() {
		...
		@SuppressWarnings("unused") final Label delayLabel = JOE_L_JobOptionsForm_Delay.Control(new Label(group3, SWT.NONE));
