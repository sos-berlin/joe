...
public class JobOptions extends FormBaseClass {
	...
	@SuppressWarnings("unused") private final String	conClassName			= "JobOptions";
	...
	private void createMainOptionsGroup() {
		...
		@SuppressWarnings("unused") final Label warnIfShorterLabel = SOSJOEMessageCodes.JOE_L_JobMainOptionForm_WarnIfShorter.Control(new Label(
				gMainOptionsGroup, SWT.NONE));
