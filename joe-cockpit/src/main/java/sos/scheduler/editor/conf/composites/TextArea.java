...
public class TextArea extends StyledText /* Text */{
    ...
    @SuppressWarnings("unused")
    private final String conSVNVersion = "$Id: TextArea.java 21291 2013-11-06 10:48:25Z ur $";
    ...
    private void createContextMenue() {
         ...
         * itemSaveAs.setText("Save as ..."); MenuItem itemReadFrom = new
         * MenuItem(objContextMenu, SWT.PUSH);
    ...
    public TextArea(Composite pobjComposite, int arg1) {
         ...
         * handleEvent(Event event) { StyledText s = (StyledText)event.widget;
         * Menu menu = new Menu (s.getShell(), SWT.POP_UP); MenuItem item = new
         * MenuItem (menu, SWT.PUSH); item.setText("Click here");
