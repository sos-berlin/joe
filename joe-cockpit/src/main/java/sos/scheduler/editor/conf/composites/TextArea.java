...
public class TextArea extends StyledText /* Text */{
	...
	@SuppressWarnings("unused") private static Logger	logger			= Logger.getLogger(TextArea.class);
	@SuppressWarnings("unused") private final String	conSVNVersion	= "$Id: TextArea.java 21291 2013-11-06 10:48:25Z ur $";
	...
	@SuppressWarnings("unused") private Listener getSaveAsListener() {
		return new Listener() {
	...
	@SuppressWarnings("unused") private Listener getStartExternalEditorListener() {
		return new Listener() {
			public void handleEvent(Event e) {
	...
	@SuppressWarnings("unused") private Listener getReadFileListener() {
		return new Listener() {
			public void handleEvent(Event e) {
	...
	public TextArea(Composite pobjComposite, int arg1) {
		...
		addHelpListener(new HelpListener() {
			@Override public void helpRequested(HelpEvent objHelpEvent) {
