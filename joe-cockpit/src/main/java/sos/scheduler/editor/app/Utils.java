...
public class Utils {
    ...
    static final String JOE_L_OBJECT_IN_USE = "JOE_L_Object_In_Use";
    static final String JOE_L_PROCESS_CLASS = "processclass";
    static final String JOE_L_JOB = "job";
    static final String JOE_L_JOB_CHAIN = "job_chain";
    static final String JOE_L_LOCK = "lock";
    static final String JOE_L_SCHEDULE = "schedule";
    ...
    public static boolean isElementEnabled(String which, SchedulerDom dom, Element elem) {
        ...
        if ("commands".equalsIgnoreCase(which) && listOfReadOnly != null
                    && listOfReadOnly.contains(which + "_" + Utils.getAttributeValue("job_chain", elem) + "," + Utils.getAttributeValue("id", elem))) {
            return false;
        } else if (listOfReadOnly != null && listOfReadOnly.contains(which + "_" + Utils.getAttributeValue("name", elem))) {
            return false;
        }
        return true;
    }
            ...
            if (elem != null && elem.getParentElement() != null && !"spooler".equalsIgnoreCase(elem.getParentElement().getName())) {
                if ("job".equalsIgnoreCase(elem.getName()) || "job_chain".equalsIgnoreCase(elem.getName()) || "add_order".equalsIgnoreCase(elem.getName())
                    ...
                    return elem;
                        ...
                        || "process_class".equalsIgnoreCase(elem.getParentElement().getName()) || "schedule".equalsIgnoreCase(elem.getParentElement().getName()) 
    ...
    public static boolean checkElement(String name, SchedulerDom _dom, int type, String which) {
        ...
        try {
            String isUsed = elementIsUsed(name, _dom, type, which);
    ...
    public static void reset(Element elem, IDataChanged update, DomParser currdom) {
        try {
            ...
            } else if (currdom instanceof com.sos.joe.xml.Events.ActionsDom) {
                ((ActionsForm) update).updateTree("main");
            } else if (currdom instanceof com.sos.joe.xml.jobdoc.DocumentationDom) {
