...
public class MainWindow {
    ...
    @I18NMessages(value = { @I18NMessage("Open"),
            ...
            @I18NMessage(value = "Open", locale = "it", explanation = "Open")}, 
    ...
    @I18NMessages(value = { @I18NMessage("Configuration"),
            ...
            @I18NMessage(value = "Configuration", locale = "it", explanation = "Configuration")}, 
    ...
    @I18NMessages(value = { @I18NMessage("New"),
            ...
            @I18NMessage(value = "New", locale = "it", explanation = "New")}, 
        ...
        try {
            ...
            if (container.getCurrentTab().getData("ftp_title") != null && !container.getCurrentTab().getData("ftp_title").toString().isEmpty()) {
                ...
                if (((SchedulerDom) currdom).isLifeElement()) {
                    ...
                    if (!aktFilename.isEmpty() && !aktFilename.equalsIgnoreCase(oldFilename)) {
                            ...
                            try {
                                ...
                                if (hFFiles.containsKey(fFile.getName())) {
                                    ...
                                    if (!(((SchedulerDom) dom).getChangedJob().get(n) != null 
                                            && ((SchedulerDom) dom).getChangedJob().get(n).equals(SchedulerDom.DELETE))) {
                                        newFFiles.add(fFile);
                                    }
                                }
                            } catch (Exception e) {
